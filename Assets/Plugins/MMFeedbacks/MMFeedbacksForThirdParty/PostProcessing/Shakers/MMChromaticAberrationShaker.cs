...
namespace MoreMountains.FeedbacksForThirdParty
{
    ...
    public class MMChromaticAberrationShaker : MonoBehaviour
    {
        ...
        protected virtual void Update()
        {
            ...
            {
                Shaking = false;
                _chromaticAberration.intensity.Override(_initialIntensity.value);
            }
        }
        ...
        protected virtual void Shake()
        {
            ...
            if (RelativeIntensity) { _chromaticAberration.intensity.Override(_chromaticAberration.intensity.value + _initialIntensity.value); }
