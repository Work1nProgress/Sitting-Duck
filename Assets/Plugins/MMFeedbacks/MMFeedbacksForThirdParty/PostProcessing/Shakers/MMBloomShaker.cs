...
namespace MoreMountains.FeedbacksForThirdParty
{
    ...
    public class MMBloomShaker : MonoBehaviour
    {
        ...
        protected MinFloatParameter _initialIntensity;
        protected MinFloatParameter _initialThreshold;
        ...
        protected virtual void Update()
        {
            ...
            if (Shaking && (Time.time - _shakeStartedTimestamp > ShakeDuration))
            {
                ...
                _bloom.intensity.Override(_initialIntensity.value);
                _bloom.threshold.Override(_initialThreshold.value);
            }
        }
        ...
        protected virtual void Shake()
        {
            ...
            if (RelativeIntensity) { _bloom.intensity.Override(_bloom.intensity.value + _initialIntensity.value); }
            if (RelativeIntensity) { _bloom.threshold.Override(_bloom.threshold.value + _initialThreshold.value); }
        }
